...
- **Tier 1 (GPT-5.5)**: Directors who make high-level decisions
...
- **Tier 2 (GPT-5.3 Codex)**: Department leads who own their domain
  - `game-designer`, `lead-programmer`, `art-director`, `audio-director`,
    `narrative-director`, `qa-lead`, `release-manager`, `localization-lead`

- **Tier 3 (GPT-5.3 Codex/GPT-5.4 Mini)**: Specialists who execute within their domain
