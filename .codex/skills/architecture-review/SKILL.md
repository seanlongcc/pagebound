...
After completing the engine audit above, spawn the **primary engine specialist** via `spawn_agent` for a domain-expert second opinion:
...
Then close with `request_user_input`:
