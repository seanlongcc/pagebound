...
**Model tier:** GPT-5.5 (multi-document synthesis, high-stakes architecture and phase gate verdicts).
...
- [ ] Model tier is `gpt-5.5` per coordination-rules.md (directors with gate synthesis = GPT-5.5)
