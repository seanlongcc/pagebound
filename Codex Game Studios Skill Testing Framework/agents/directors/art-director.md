...
**Model tier:** GPT-5.3 Codex (note: despite the "director" title, art-director is assigned GPT-5.3 Codex per coordination-rules.md — it handles individual system analysis, not multi-document phase gate synthesis at the GPT-5.5 level).
...
- [ ] Model tier is `gpt-5.3-codex` (NOT GPT-5.5 — coordination-rules.md assigns GPT-5.3 Codex to art-director)
