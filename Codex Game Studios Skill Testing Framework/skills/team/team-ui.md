...
2. Three `spawn_agent` calls issued simultaneously: ux-designer, art-director, accessibility-specialist
...
**Assertions:**
- [ ] All three `spawn_agent` calls issued before any result is awaited (parallel, not sequential)
