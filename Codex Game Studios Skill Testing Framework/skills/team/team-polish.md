...
- [ ] Phases 3 and 4 `spawn_agent` calls are issued at the same time as Phase 2 (not after Phase 2 completes)
...
- [ ] engine-programmer and performance-analyst `spawn_agent` calls in Phase 2 are issued simultaneously (not sequentially)
