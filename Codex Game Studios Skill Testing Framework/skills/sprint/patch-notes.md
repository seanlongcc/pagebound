...
`/patch-notes` is a GPT-5.4 Mini-tier skill that generates player-facing patch notes
...
3. Skill runs on GPT-5.4 Mini model — fast compilation
...
- [ ] Runs on GPT-5.4 Mini model tier (fast, low-cost)
