# Codex Game Studios Skill Testing Framework — Codex Instructions
...
- Skill specs: `Codex Game Studios Skill Testing Framework/skills/[category]/[name].md`
- Agent specs: `Codex Game Studios Skill Testing Framework/agents/[tier]/[name].md`
- Catalog: `Codex Game Studios Skill Testing Framework/catalog.yaml`
- Rubric: `Codex Game Studios Skill Testing Framework/quality-rubric.md`
...
CGS skills or agents themselves. `/skill-test` and `/skill-improve` will report that
