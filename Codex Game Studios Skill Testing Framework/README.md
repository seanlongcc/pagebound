# Codex Game Studios Skill Testing Framework
...
> Game developers using CGS don't need it. To remove it entirely:
> `rm -rf "Codex Game Studios Skill Testing Framework"` — nothing in `.codex/` depends on it.
...
```bash
rm -rf "Codex Game Studios Skill Testing Framework"
```
