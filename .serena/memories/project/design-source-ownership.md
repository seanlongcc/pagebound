...
- Exact MVP weapon candidate rows, L1/L5/L10 milestones, upgrade pools, catalyst assignments, and numeric weapon tuning live in `design/gdd/mvp-weapon-candidate-pool.md`; root section 11 references that focused sheet instead of duplicating weapon tables.
