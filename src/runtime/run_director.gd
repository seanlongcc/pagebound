...
const TIME_BANDS := [
	{"id": &"opening", "start_seconds": 0.0, "target": 8, "spawn_interval": 1.7, "batch_size": 1, "health_multiplier": 1.0},
	{"id": &"first_pressure", "start_seconds": 60.0, "target": 16, "spawn_interval": 1.15, "batch_size": 1, "health_multiplier": 1.15},
	{"id": &"ink_surge", "start_seconds": 120.0, "target": 26, "spawn_interval": 0.9, "batch_size": 2, "health_multiplier": 1.3},
	{"id": &"page_crush", "start_seconds": 240.0, "target": 42, "spawn_interval": 0.72, "batch_size": 2, "health_multiplier": 1.5},
]
